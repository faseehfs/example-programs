...
def InputFunction():  # Gets the input, make it all lowercase and split it into a list. Doesn't split if the input is empty.
    ...
    Response = (
        Response.lower()
    )  # .lower() method makes all the characters in a string lowercase. Methods != functions. They have a dot(.)
    if Response != "":
        Response = (
            Response.split()
        )  # .split() method splits the string into a list. Methods != functions. They have a dot(.)
...
def NumbersGettingFunction():  # Function that gets the first two numbers in the response.
    ...
    while (
        NumberOfNumbers != 1 and x != 100
    ):  # Finding the first number. The operation stops if x becomes 100.
        try:
    ...
    if x == 100:
        print(
            ChatBotName
            + ": "
            + "Sorry. It seems like you didn't provide me the numbers or there is some other issue. Anyways, Sorry. Let's try again."
        )
...
def AdditionFunction():
    ...
    print(
        ChatBotName
        + ": "
        + "The sum of the numbers you provided is "
        + str(Sum)
        + ". Thanks."
    )
...
print(
    ChatBotName + ": " + "Hello! I am " + ChatBotName + ". What is your name?"
)  # Getting Username.
InputFunction()
Username = Response[-1]

print(
    ChatBotName + ": " + "It looks like your name is " + Username + ". Right?"
)  # Confirming Username.
InputFunction()
while (
    "yes" not in Response
    and "sure" not in Response
    and "exactly" not in Response
    and "yeah" not in Response
    and "yep" not in Response
    and "ya" not in Response
    and "m" not in Response
    and "mm" not in Response
    and "mmm" not in Response
):
...
print(
    ...
    + "Ok, let's continue, "
    + Username
    + ". I can do addition and multiplication. How can I help you?"
)


numberOfNotUnderstoodResponses = (
    0  # To keep track of how many times the chatbot said "I don't know".
)
while True:
    InputFunction()
    ...
    if (
        "can" in Response
        or "could" in Response
        or "will" in Response
        or "would" in Response
        and "you" in Response
        and "add" in Response
    ):
    ...
    if "add" in Response or "plus" in Response or "+" in Response:
        ...
        AdditionFunction()
    if (
        "multiply" in Response
        or "product" in Response
        or "*" in Response
        or "times" in Response
    ):
        ResponseUnderstood = True
        NumbersGettingFunction()
    ...
    if (
        "wow" in Response
        or "unbelievable" in Response
        or "extraordinary" in Response
        or "amazing" in Response
        or "awesome" in Response
        or "impressive" in Response
        or "wonderful" in Response
        or "super" in Response
    ):
        ResponseUnderstood = True
        print(
            ChatBotName
            + ": "
            + "I am glad that you liked me, "
            + Username
            + ". I can help you more, and it's my pleasure."
        )
    ...
    if ("perform" in Response or "do" in Response) and "addition" in Response:
        ...
        try:
            ...
            print(
                ChatBotName
                + ": "
                + "Sorry. It seems like you didn't provide me the numbers or there is some other issue. Let's try again."
            )
    ...
    if (
        "where" in Response
        and "you" in Response
        and ("live" in Response or "reside" in Response or "stay" in Response)
    ):
        ResponseUnderstood = True
    ...
    if (
        ...
        print(
            ChatBotName
            + ": "
            + "My house is this computer now. But I was born in the PC of Faseeh. Do you know him?"
        )
        InputFunction()
        if (
            "yes" in Response
            or "sure" in Response
            or "absolutely" in Response
            or "yeah" in Response
            or "yep" in Response
            or "ya" in Response
            or "m" in Response
            ...
            print(
                ChatBotName
                + ": "
                + "Oh, That's great! He was a nice guy. I really miss him."
            )
        else:
            print(
                ChatBotName
                + ": "
                + "I think you don't know him. I wonder then how you got this program. Don't try to explain me. I won't understand."
            )

    if (
        "who" in Response
        or "whome" in Response
        and "create" in Response
        or "created" in Response
        or "make" in Response
        or "made" in Response
        or "build" in Response
        or "built" in Response
        and "you" in Response
    ):
        ResponseUnderstood = True
    ...
    if "nope" in Response or "no" in Response or "never" in Response:
        ...
        if (
            ...
            time.sleep(
                1
            )  # This sleep method in the time module stops the execution of the programme for the given time. In this case, one second.
            sys.exit()  # This method from the sys module ends the program.
        else:
            print(
                ChatBotName
                + ": "
                + "It looks like you don't want to make me leave. Thanks, how can I help you?"
            )
    ...
    if ResponseUnderstood == False:
        if numberOfNotUnderstoodResponses == 0:
            print(
                ChatBotName
                + ": "
                + "Sorry, I didn't understand what you said. Can you say it in another way?"
            )
        if numberOfNotUnderstoodResponses == 1:
            print(
                ChatBotName
                + ": "
                + "Sorry, I am still not getting it. Shall we talk about something else?"
            )
        if numberOfNotUnderstoodResponses == 2:
            print(
                ChatBotName
                + ": "
                + "I am so sorry, this is the third time I don't understand."
            )
        if numberOfNotUnderstoodResponses == 3:
            print(
                ChatBotName
                + ": "
                + "Still no idea. Sorry for the disappointment. Do you want me to leave?"
            )
            InputFunction()
            if (
                "go" in Response
                ...
                print(
                    ChatBotName
                    + ": "
                    + "It looks like you don't want me to leave eventhough I don't understand anything. Thanks, you are a great person. How can I help you?"
                )
